...
_This section demonstrates a real-world application using the patterns above. It's project-specific — adapt the schemas and logic for your own use case._
