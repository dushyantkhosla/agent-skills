...
> **Provenance.** Adapted from Anthropic's upstream skill-authoring guide.
> Links in this document point into that upstream documentation; the
> referenced files are not vendored in this repo.
